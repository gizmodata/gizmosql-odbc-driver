...
```
./main.py  --sql_query="SELECT * FROM table_name" py --driver /home/user/odbc_driver/_build/release/libgizmosql-odbc.so --host localhost --port 31337 --user username --password password123 pyodbc test-fetch-all
```

### test_case=test-sql-type-*<type_name>*

```
./main.py --driver /home/user/odbc_driver/_build/release/libgizmosql-odbc.so --host localhost --port 31337 --user username --password password123 pyodbc test-sql-type-all
```
